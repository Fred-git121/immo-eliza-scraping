...
# Define all the search URLs to scrape (apartments only, excluding new construction)
SEARCH_URLS = [
    "https://immovlan.be/en/real-estate?transactiontypes=for-sale,in-public-sale&propertytypes=apartment&propertysubtypes=apartment,ground-floor,penthouse,duplex,studio,loft,triplex&minbedrooms=1&maxbedrooms=1&isnewconstruction=no&noindex=1",
    "https://immovlan.be/en/real-estate?transactiontypes=for-sale,in-public-sale&propertytypes=apartment&propertysubtypes=apartment,ground-floor,penthouse,duplex,studio,loft,triplex&minbedrooms=2&maxbedrooms=2&isnewconstruction=no&noindex=1",
    "https://immovlan.be/en/real-estate?transactiontypes=for-sale,in-public-sale&propertytypes=apartment&propertysubtypes=apartment,ground-floor,penthouse,duplex,studio,loft,triplex&minbedrooms=3&maxbedrooms=3&isnewconstruction=no&noindex=1",
    "https://immovlan.be/en/real-estate?transactiontypes=for-sale,in-public-sale&propertytypes=apartment&propertysubtypes=apartment,ground-floor,penthouse,duplex,studio,loft,triplex&minbedrooms=4&maxbedrooms=4&isnewconstruction=no&noindex=1",
    "https://immovlan.be/en/real-estate?transactiontypes=for-sale,in-public-sale&propertytypes=apartment&propertysubtypes=apartment,ground-floor,penthouse,duplex,studio,loft,triplex&tags=hasgarden&isnewconstruction=no&noindex=1",
    "https://immovlan.be/en/real-estate?transactiontypes=for-sale,in-public-sale&propertytypes=apartment&propertysubtypes=apartment,ground-floor,penthouse,duplex,studio,loft,triplex&tags=hasterrace&isnewconstruction=no&noindex=1",
]
...
def scrape_property_urls():
    ...
    with open("apartment_sale_urls.csv", "w", encoding="utf-8") as f:
...
if __name__ == "__main__":
    ...
    with open("immovlan_apartment_sales.csv", "w", newline="", encoding="utf-8") as f:
        writer = csv.writer(f)
    ...
    print(f"\nFinished scraping {len(all_specs)} properties. Saved to immovlan_apartment_sales.csv")